 ...
 var mainPage = Ext.extend(Ext.Viewport,{
 	...
 	constructor: function(username, date){
 		mainPage.superclass.constructor.call(this,{
 			...
 			items: [{
 				...
 				layout: 'absolute',
 				html: '<table class="header"><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;MIS</td><td class="header_center"></td>' +
 				...
 				frame: true,
 				height: 30,
 				html: "<div id='author'>Copyright &copy 2014-"+ new Date().getFullYear()+" fnzi</div>"
 			}]
 		});
 	},
 	...
 	center: new Ext.TabPanel({
 		...
 		items: [{
 			...
 			html: '<iframe src="" frameborder=0 width=100% height=100%/>'
 		}]
 	}),
